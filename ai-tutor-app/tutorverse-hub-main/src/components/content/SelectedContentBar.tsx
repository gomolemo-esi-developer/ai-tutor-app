...
import { X, FileText, Video, File, HelpCircle, MessageSquare, Wand2, AlertTriangle } from 'lucide-react';
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <div>
                                        <Badge
                                            variant="secondary"
                                            className={cn(
                                                "flex items-center gap-1.5 pr-1 py-1 bg-background border cursor-help",
                                                item.isOrphaned
                                        ...
                                        >
                                            ...
                                            {!item.isOrphaned && getTypeIcon(item.type)}
                                ...
                                {item.isOrphaned && (
                                    <TooltipContent className="max-w-xs">
                                        <p className="text-xs">
                                            This file is no longer available in your enrolled modules. It may have been deleted or moved.
                                        </p>
                                    </TooltipContent>
                                )}
                            </Tooltip>
